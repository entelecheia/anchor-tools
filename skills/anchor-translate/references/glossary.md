# RISE(앵커) 공식 용어집 (한영 대역)

## 사용 규칙

- 이 용어집에 등재된 용어는 번역 시 반드시 해당 영문/국문 표기 사용
- 등재되지 않은 용어는 문맥에 맞게 번역 후 병기 권장
- 최초 등장 시: `앵커 사업 (Anchor Project)` → 이후 `Anchor Project` 단독 사용 가능
...
| 한국어 | 영어 | 비고 |
|--------|------|------|
| 제주한라대학교 | Cheju Halla University | **Jeju Halla 사용 금지** |
| CHU | CHU | 약칭 유지 |
...
| 핵심인재 | Core Talent |
| 지역성장 인재양성체계 | Regional Growth Talent Development System |
