...
- 이 용어집에 등재된 용어는 번역 시 반드시 해당 표기 사용
- 신규 용어 발견 시 운영지원본부에 추가 요청
- 최초 등장: 전체명 + 약어 병기 → 이후 약어 단독 사용 가능
...
| 한국어 | 영어 | 약어 |
|--------|------|------|
| 제주한라대학교 | Cheju Halla University | CHU |
...
| 한국어 | 영어 | 비고 |
|--------|------|------|
| 런케이션 | Learncation | Learning + Vacation 조어 |
| Study Jeju | Study Jeju | 고유명사 유지 |
| AI 융합전공 | AI Convergence Major | |
| AI Native Campus | AI Native Campus | 고유명사 유지 |
| 핵심인재 | Core Talent | |
| 트랙 | Track | 전공 트랙 |
| 늘봄 | Neulbom (After-school Care) | 고유명사 병기 |
| 하원테크노캠퍼스 | Hawon Techno Campus | |
...
| 집행액 | executed (disbursed) amount |
| 잔액 | remaining balance |
| 불용액 | unused / unspent funds |
| 이월 | carryover |
| 간접비 | indirect costs / overhead |
| 개조식 | bullet-point / outline format |
| 성과지표 | performance indicator / KPI |
| 정량지표 | quantitative indicator |
| 정성지표 | qualitative indicator |
| 달성률 | achievement rate |
| 사업 기간 | project period |
| 협약 | agreement / MOU |
| 업무협약 | Memorandum of Understanding (MOU) |
...
| 우주항공 | Aerospace |
| 방산 | Defense Industry |
| 드론 | Drone / UAV (Unmanned Aerial Vehicle) |
...
| 한국어 구문 | 영어 표현 |
|------------|----------|
| ~을 추진하고 있습니다 | is currently implementing / advancing |
| ~을 완료하였습니다 | has been completed / was successfully completed |
| ~을 체결하였습니다 | has signed / entered into [an agreement] |
| ~을 목표로 합니다 | aims to / targets |
| 향후 계획 | Future Plans |
| 주요 성과 | Key Achievements |
| 추진 배경 | Background |
| 기대 효과 | Expected Outcomes |
| 붙임 | Attachment / Enclosure |
| 끝. | (End of document) |
...
| 한국어 | 영어 |
|--------|------|
| 2026. 4. 5. | April 5, 2026 (공문) / 2026-04-05 (데이터) |
| ○○억 원 | KRW ○○0 million / approximately USD ○○ million |
| ○○명 | ○○ participants / ○○ students |
| ○○% | ○○% (동일) |
